...
import org.eclipsetrader.kdb.internal.core.connector.SnapshotConnector;
...
public class AuthenticationPage extends PreferencePage implements IWorkbenchPreferencePage {
    ...
    public void init(IWorkbench workbench) {
        setPreferenceStore(KdbActivator.getDefault().getPreferenceStore());
    }
    ...
    protected void performApply() {
        switch (driver.getSelectionIndex()) {
            case 0:
                getPreferenceStore().setValue(KdbActivator.PREFS_DRIVER, SnapshotConnector.class.getName());
                break;
        }
    }
    ...
    protected int getDriverIndex() {
        String driver = getPreferenceStore().getString(KdbActivator.PREFS_DRIVER);
