...
package org.eclipsetrader.kdb.internal.ui.wizards;
...
public class ImportDataPage extends WizardPage {
    ...
    public ImportDataPage() {
        super("data", Messages.ImportDataPage_Import, null); //$NON-NLS-1$
        setDescription(Messages.ImportDataPage_SelectImportSecurity);
    }
    ...
    protected void restoreState() {
        IDialogSettings dialogSettings = KdbActivator.getDefault().getDialogSettings().getSection(getClass().getName());
    ...
    public void saveState() {
        IDialogSettings dialogSettings = KdbActivator.getDefault().getDialogSettings().getSection(getClass().getName());
        if (dialogSettings == null) {
            dialogSettings = KdbActivator.getDefault().getDialogSettings().addNewSection(getClass().getName());
        }
