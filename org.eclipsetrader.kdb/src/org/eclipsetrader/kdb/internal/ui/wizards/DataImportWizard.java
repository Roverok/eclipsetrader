...
public class DataImportWizard extends Wizard implements IImportWizard {
    ...
    public DataImportWizard() {
        setWindowTitle(Messages.DataImportWizard_ImportDataFromKDB);
        setDefaultPageImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(KdbActivator.PLUGIN_ID, "icons/wizban/import_wiz.png")); //$NON-NLS-1$
    }
