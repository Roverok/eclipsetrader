...
package org.eclipsetrader.kdb.internal;
 ...
 */
public class KdbActivator extends AbstractUIPlugin {

    // The plug-in ID
    public static final String PLUGIN_ID = "org.eclipsetrader.kdb";
    ...
    // The shared instance
    private static KdbActivator plugin;
     ...
     */
    public static KdbActivator getDefault() {
        return plugin;
    }
