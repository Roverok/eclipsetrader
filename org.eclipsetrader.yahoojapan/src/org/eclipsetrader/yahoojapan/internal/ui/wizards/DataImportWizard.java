...
public class DataImportWizard extends Wizard implements IImportWizard {
    ...
    public DataImportWizard() {
        setWindowTitle(Messages.DataImportWizard_ImportFromYahooJAPAN);
        setDefaultPageImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin(YahooJapanActivator.PLUGIN_ID, "icons/wizban/import_wiz.png")); //$NON-NLS-1$
    }
