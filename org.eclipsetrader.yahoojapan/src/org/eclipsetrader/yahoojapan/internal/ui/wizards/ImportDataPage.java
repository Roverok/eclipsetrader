...
public class ImportDataPage extends WizardPage {
    ...
    protected void restoreState() {
        IDialogSettings dialogSettings = YahooJapanActivator.getDefault().getDialogSettings().getSection(getClass().getName());
    ...
    public void saveState() {
        IDialogSettings dialogSettings = YahooJapanActivator.getDefault().getDialogSettings().getSection(getClass().getName());
        if (dialogSettings == null) {
            dialogSettings = YahooJapanActivator.getDefault().getDialogSettings().addNewSection(getClass().getName());
        }
