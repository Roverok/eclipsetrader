...
public class Messages extends NLS {
    ...
    public static String MAType_Exponential;
    public static String MAType_DoubleExponential;
    public static String MAType_KaufmanAdaptive;
    public static String MAType_MESAAdaptive;
    public static String MAType_Simple;
    public static String MAType_Triangular;
    public static String MAType_TripleExponential;
    public static String MAType_TripleExponentialT3;
    public static String MAType_Weighted;
