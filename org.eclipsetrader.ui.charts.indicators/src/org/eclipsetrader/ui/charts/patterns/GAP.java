...
public class GAP implements IChartObjectFactory, IGeneralPropertiesAdapter, ILineDecorator, IExecutableExtension {
    ...
    public IChartObject createObject(IDataSeries source) {
        ...
        for (int i = values.length - 3; i >= 0; i--) {
            ...
            if (rec0.getHigh() < rec1.getLow() && closesInTopQuarter(rec1) && closesInTopQuarter(rec2)) {
            ...
            else if (rec1.getHigh() < rec0.getLow() && closesInBottomQuarter(rec1) && closesInBottomQuarter(rec2)) {
                IOHLC[] outBars = new IOHLC[] {
                        rec0, rec1, rec2
                };
