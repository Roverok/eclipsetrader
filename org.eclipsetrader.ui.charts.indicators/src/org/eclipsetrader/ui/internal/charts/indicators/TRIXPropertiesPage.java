...
import org.eclipsetrader.ui.charts.indicators.TRIX;
import org.eclipsetrader.ui.internal.charts.OHLCFieldInput;

public class TRIXPropertiesPage extends PropertyPage {

    private OHLCFieldInput input;
    private Spinner period;

    public TRIXPropertiesPage() {
    ...
    protected Control createContents(Composite parent) {
        ...
        setTitle(Messages.OnedayROCOfATripleSmoothEMA);
    ...
    protected void performDefaults() {
        TRIX object = (TRIX) getElement().getAdapter(TRIX.class);
