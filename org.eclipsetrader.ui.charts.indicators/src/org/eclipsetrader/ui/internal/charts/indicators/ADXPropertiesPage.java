...
import org.eclipsetrader.ui.charts.indicators.ADX;

public class ADXPropertiesPage extends PropertyPage {

    private Spinner period;

    public ADXPropertiesPage() {
    ...
    protected void performDefaults() {
        ADX object = (ADX) getElement().getAdapter(ADX.class);
