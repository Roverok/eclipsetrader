...
import org.eclipsetrader.ui.charts.indicators.AROONOSC;

public class AROONOSCPropertiesPage extends PropertyPage {

    private Spinner period;

    public AROONOSCPropertiesPage() {
    ...
    protected Control createContents(Composite parent) {
        ...
        setTitle(Messages.AroonOscillator);
    ...
    protected void performDefaults() {
        AROONOSC object = (AROONOSC) getElement().getAdapter(AROONOSC.class);
