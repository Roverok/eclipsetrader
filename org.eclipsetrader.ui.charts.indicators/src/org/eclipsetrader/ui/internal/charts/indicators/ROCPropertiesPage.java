...
import org.eclipsetrader.ui.charts.indicators.ROC;
import org.eclipsetrader.ui.internal.charts.OHLCFieldInput;

public class ROCPropertiesPage extends PropertyPage {

    private OHLCFieldInput input;
    private Spinner period;

    public ROCPropertiesPage() {
    ...
    protected Control createContents(Composite parent) {
        ...
        setTitle(Messages.RateOfChange);
    ...
    protected void performDefaults() {
        ROC object = (ROC) getElement().getAdapter(ROC.class);
