...
import org.eclipsetrader.ui.charts.indicators.SUM;
import org.eclipsetrader.ui.internal.charts.OHLCFieldInput;

public class SUMPropertiesPage extends PropertyPage {

    private OHLCFieldInput input;
    private Spinner period;

    public SUMPropertiesPage() {
    ...
    protected void performDefaults() {
        SUM object = (SUM) getElement().getAdapter(SUM.class);
