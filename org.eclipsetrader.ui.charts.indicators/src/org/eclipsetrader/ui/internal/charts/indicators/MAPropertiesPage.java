...
public class MAPropertiesPage extends PropertyPage {
    ...
    protected void performDefaults() {
        MA object = (MA) getElement().getAdapter(MA.class);
        input.setSelection(object.getField());
        period.setSelection(object.getPeriod());
        type.setSelection(object.getType());
    ...
    public boolean performOk() {
        ...
        object.setType(type.getSelection());
