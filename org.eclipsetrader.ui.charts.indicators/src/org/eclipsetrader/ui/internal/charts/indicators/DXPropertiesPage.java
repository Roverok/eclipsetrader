...
import org.eclipsetrader.ui.charts.indicators.DX;

public class DXPropertiesPage extends PropertyPage {

    private Spinner period;

    public DXPropertiesPage() {
    ...
    protected Control createContents(Composite parent) {
        ...
        setTitle(Messages.DirectionalMovementIndex);
    ...
    protected void performDefaults() {
        DX object = (DX) getElement().getAdapter(DX.class);
