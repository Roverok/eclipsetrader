...
import org.eclipsetrader.ui.charts.indicators.NATR;

public class NATRPropertiesPage extends PropertyPage {

    private Spinner period;

    public NATRPropertiesPage() {
    ...
    protected Control createContents(Composite parent) {
        ...
        setTitle(Messages.NormalizedAverageTrueRange);
    ...
    protected void performDefaults() {
        NATR object = (NATR) getElement().getAdapter(NATR.class);
