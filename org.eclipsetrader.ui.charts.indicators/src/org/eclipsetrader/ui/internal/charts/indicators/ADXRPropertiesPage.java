...
import org.eclipsetrader.ui.charts.indicators.ADXR;

public class ADXRPropertiesPage extends PropertyPage {

    private Spinner period;

    public ADXRPropertiesPage() {
    ...
    protected Control createContents(Composite parent) {
        ...
        setTitle(Messages.ADMovementIndexRating);
    ...
    protected void performDefaults() {
        ADXR object = (ADXR) getElement().getAdapter(ADXR.class);
