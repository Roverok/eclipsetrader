...
import org.eclipsetrader.ui.charts.indicators.LINEARREG;
import org.eclipsetrader.ui.internal.charts.OHLCFieldInput;

public class LINEARREGPropertiesPage extends PropertyPage {

    private OHLCFieldInput input;
    private Spinner period;

    public LINEARREGPropertiesPage() {
    ...
    protected void performDefaults() {
        LINEARREG object = (LINEARREG) getElement().getAdapter(LINEARREG.class);
