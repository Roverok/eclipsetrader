...
import org.eclipsetrader.yahoojapanfx.internal.core.connector.BackfillConnector;
        ...
        try {
            ...
            for (ISecurity security : securities) {
                ...
                try {
                    ...
                    Status status = new Status(IStatus.ERROR, Activator.PLUGIN_ID, 0, "Error downloading data for " + security, e);
                    Activator.log(status);
                }
