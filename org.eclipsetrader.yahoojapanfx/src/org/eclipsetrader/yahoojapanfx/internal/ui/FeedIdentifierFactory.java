...
package org.eclipsetrader.yahoojapanfx.internal.ui;
...
public class FeedIdentifierFactory implements IDataProviderFactory, IExecutableExtension, IExecutableExtensionFactory {
    ...
    public class DataProvider implements IDataProvider {
        ...
        public IDataProviderFactory getFactory() {
            return FeedIdentifierFactory.this;
        }
            ...
            if (identifier != null) {
                ...
                if (properties != null) {
                    if (properties.getProperty("org.eclipsetrader.yahoojapanfx.symbol") != null) {
                        final String value = properties.getProperty("org.eclipsetrader.yahoojapanfx.symbol");
